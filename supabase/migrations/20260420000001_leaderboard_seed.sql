-- Reset benchmark rows and leaderboard links, then seed tasks + evaluation metrics.
...
-- Drop leaderboard links that are not the five evaluation scalars (e.g. legacy columns).
